...
const Judges = () => {
  return (
    <div className="from-cutie-blue-200 to-cutie-blue-300 font-righteous -mt-1 flex flex-col items-center justify-center gap-10 bg-gradient-to-b from-[70%] py-10">
