...
const FAQ = () => {
  return (
    <div className="flex h-full w-full flex-col items-center bg-cutie-blue-300 font-righteous text-white">
      <div className="flex flex-row items-center justify-center gap-2 py-4 align-middle text-7xl">
        <h1>F</h1>
        <Image src={UFO} alt="UFO" className="size-1/3" />
        <h1>Q</h1>
      </div>
