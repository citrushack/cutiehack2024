...
const ProtectedPage = async ({ children, restrictions, title }) => {
  ...
  return (
    <>
      ...
      <div className="from-cutie-blue-300 to-cutie-blue-200 z-0 flex h-screen w-full items-start justify-center overflow-x-hidden bg-gradient-to-b py-12 lg:py-0">
